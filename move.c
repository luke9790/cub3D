...
/*   Updated: 2023/10/02 10:14:00 by pcocci           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// The camera plane defines the 2D plane in the player's field of view onto which the 3D game world is projected. 
// per muovere a destra moltiplca sin e cos con costante negativa, per muovere a sinistra constante positiva;
...
// Check se nella direzione in cui mi voglio muovere c'e' un muro, se si aggiorno coordinate.
// La collisione c'e' ma controllo SOLO nella direzione in cui punta la camera, di conseguenza 
// non e' super realistica perche' il players "sbatte" su un angolo del muro e comunque cammina
// Andrebbe fatto controllando a cerchio... pero' ecco, dio cane v.v
